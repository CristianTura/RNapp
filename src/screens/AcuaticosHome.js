...
const AcuaticosHome = (props) => {
  ...
  useEffect(() => {
    ...
    const setupAudio = async () => {
      try {
        await loadBackgroundSound(require('../../assets/audio/acuaticos.mp3'), true);
      } catch (error) {
      ...
      {/* <ReactNativeZoomableView
        ...
        <ScrollView
          ...
          <ImageBackground
            ...
            source={require('../../assets/acuaticos.png')}
            // source={null}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                <Image
                source={require('../../assets/02acuaticosmin.gif')}
                style={{
                  width: wp('28%'),
                  height: wp('28%'),
                }}
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../../assets/04acuaticos.png')}
                style={{
                  width: wp('40%'),
                  height: wp('40%'),
                }}
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../../assets/05acuaticos.png')}
                style={{
                  width: wp('55%'),
                  height: wp('30%'),
                }}
              ...
              <Image
              source={require('../../assets/05acuaticosgifmin.gif')}
              style={{
                position: 'absolute',
                width: wp('45%'),
                height: wp('30%'),
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                <Image
                source={require('../../assets/06acuaticosmin.gif')}
                style={{
                  width: wp('35%'),
                  height: wp('20%'),
                }}
...
export default memo(AcuaticosHome);
// export default AgricultoresHome;
