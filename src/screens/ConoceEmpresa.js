...
import { getConoceEmpresa, medallaContenidos } from '../../api/api';
    ...
    <View style={styles.container}>
        ...
        <View>
          ...
          >
            ...
            <LinearGradient
              ...
              locations={[0, 0.9]}>
              <Text style={styles.iconoTexto}>Nosotros</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <ScrollView
        ...
        <View
          ...
          <Text style={styles.titulo}>Conoce nuestra empresa</Text>
        </View>

        {/* RENDERIZACIÓN DE CADA UNO DE LOS TEMAS / COMPONENTES */}
        <View style={{marginBottom: hp('20%')}}>
          {novedades.map((item, index) => {
            if (item.tipo == 'CONOCE_NUESTRA_EMPRESA') {
              return (
                <UltimosTemasItem
                  key={index}
