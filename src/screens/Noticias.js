...
import { getNoticias, medallaContenidos } from '../../api/api';
    ...
    <View style={styles.container}>
        ...
        <View>
          ...
          >
            ...
            <LinearGradient
              ...
              locations={[0, 0.9]}>
              <Text style={styles.iconoTexto}>Noticias de Interés</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      ...
      <ScrollView
        ...
        <View
          ...
          <Text style={styles.titulo}>Noticias de Interés</Text>
        </View>
            ...
            if (item.tipo == 'NOTICIA') {
              return (
                <UltimosTemasItem
                  ...
                  tituloPantalla="Noticias de Interés"
                />
              );
            }
          })}
